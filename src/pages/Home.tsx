      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
        <div className="cyber-card p-6">
          ...
          <p className="text-gray-300">
            Explore top skiing destinations with detailed information about trails, elevation, and difficulty levels.
          </p>
        </div>
        ...
        <div className="cyber-card p-6">
          ...
          <h3 className="text-xl font-bold mb-2 neon-text-pink">Plan Adventures</h3>
          <p className="text-gray-300">
            Create detailed skiing adventures with activities, gear lists, and invite friends to join you.
          </p>
        </div>
        ...
        <div className="cyber-card p-6">
          ...
          <h3 className="text-xl font-bold mb-2 neon-text-green">Track Progress</h3>
          <p className="text-gray-300">
            Monitor your skiing skill development and keep track of your adventures over time.
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            },
            {
              ...
              image: 'https://images.unsplash.com/photo-1611001716885-b3402558a62b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80'
            },
            {
              id: '3',
              name: 'Quantum Ridge',
              ...
              difficulty: 'EXPERT',
              image: 'https://images.unsplash.com/photo-1548777123-e216912df7d8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80'
            }
          ].map(resort => (
            <Link key={resort.id} to={`/resorts/${resort.id}`} className="block">
