      ...
      try {
        ...
        setError(
          err instanceof Error
            ? err
            : new Error('Failed to fetch resort details')
        );
      } finally {
        setLoading(false);
      }
  ...
  return (
    <div>
      <div className="mb-6">
        <Link
          to="/resorts"
          className="text-neon-blue hover:text-neon-blue/80 flex items-center gap-2"
        >
          <svg
        ...
        <div className="lg:col-span-1">
          <div className="cyber-card p-6 mb-8 sticky top-4">
            ...
            <p className="text-gray-300 mb-6">
              Ready to hit the slopes at {resort.name}? Create a new adventure
              now!
            </p>
            <Link
              ...
              <ul className="space-y-2">
                <li className="flex items-center gap-2">
                  ...
                  <span className="text-gray-300">
                    {resort.numberOfTrails} Trails of Varying Difficulty
                  </span>
                </li>
                <li className="flex items-center gap-2">
                  <svg
                  ...
                  <span className="text-gray-300">
                    Elevation of {resort.elevation}m
                  </span>
                </li>
                <li className="flex items-center gap-2">
                  <svg
                  ...
                  <span className="text-gray-300">
                    Perfect for {resort.difficulty.toLowerCase()} skiers
                  </span>
                </li>
                <li className="flex items-center gap-2">
                  <svg
